...
export default async function DashboardPage() {
  ...
  const {
    ...
    alerts,
    hasLowStockAlerts,
  } = await getDashboardMetrics(supabase, organizationId);
    ...
    <div className="flex flex-col gap-8">
      ...
      <div>
        ...
        <p className="mt-2 text-gray-600">
          Bienvenido a Jardinería CRM. Aquí tienes un resumen de hoy.
        </p>
      </div>
          ...
          <div className="rounded-xl border border-red-200 bg-red-50 p-6 shadow-sm">
            ...
            <div className="space-y-3">
              {alerts.map((supply) => (
                <div
                  key={supply.id}
                  className="flex items-center justify-between rounded-lg bg-white p-3 shadow-sm border border-red-100"
                >
      ...
      <div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Link
            href="/visits?new=true"
            className="group relative flex flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-gray-300 bg-gray-50 p-6 transition-colors hover:bg-gray-100"
          >
