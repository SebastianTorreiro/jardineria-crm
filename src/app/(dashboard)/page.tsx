...
export default async function DashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-8 p-4 pb-24 md:p-8"> {/* Added padding for bottom nav */}
      {/* Header */}
      <div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4"> {/* Grid optimized for mobile */}
            <Link href="/visits?new=true" className="group relative flex flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-gray-300 bg-gray-50 p-4 transition-colors hover:bg-gray-100">
                <div className="rounded-full bg-blue-100 p-3 group-hover:bg-blue-200">
                    <CalendarDays className="h-6 w-6 text-blue-700" />
                </div>
                <span className="font-medium text-center text-sm text-gray-900">Nueva Visita</span>
            </Link>

            <Link href="/finances?new=true" className="group relative flex flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-gray-300 bg-gray-50 p-4 transition-colors hover:bg-gray-100">
                <div className="rounded-full bg-green-100 p-3 group-hover:bg-green-200">
                    <Receipt className="h-6 w-6 text-green-700" />
                </div>
                <span className="font-medium text-center text-sm text-gray-900">Registrar Gasto</span>
            </Link>

            <Link href="/clients?new=true" className="group relative flex flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-gray-300 bg-gray-50 p-4 transition-colors hover:bg-gray-100">
                <div className="rounded-full bg-purple-100 p-3 group-hover:bg-purple-200">
                    <Users className="h-6 w-6 text-purple-700" />
                </div>
                <span className="font-medium text-center text-sm text-gray-900">Agregar Cliente</span>
            </Link>

             <Link href="/inventory" className="group relative flex flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-gray-300 bg-gray-50 p-4 transition-colors hover:bg-gray-100">
                <div className="rounded-full bg-orange-100 p-3 group-hover:bg-orange-200">
                    <Briefcase className="h-6 w-6 text-orange-700" />
                </div>
                <span className="font-medium text-center text-sm text-gray-900">Inventario</span>
            </Link>
        </div>
      </div>
    </div>
